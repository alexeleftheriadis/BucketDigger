...
def arguments():
    ...
    parser.add_argument("-t", "--typeofsearch", type=str, help="File type to search for",  default="all")
    parser.add_argument("-ms", "--maxsize", type=int, help="The max size of a file (in Bytes)", default=500000000)
